...
│                                                                  │
│  ┌──────────────────────┐         ┌──────────────────────┐     │
│  │   Beelink Mini S13   │         │   Beelink Mini S13   │     │
│  │   (Node 1)           │         │   (Node 2)           │     │
│  ├──────────────────────┤         ├──────────────────────┤     │
│  │ CPU: Intel N150      │         │ CPU: Intel N150      │     │
│  │ RAM: 16GB            │         │ RAM: 16GB            │     │
│  │ Disk: 512GB NVMe     │         │ Disk: 512GB NVMe     │     │
│  │ OS: Talos Linux      │         │ OS: Talos Linux      │     │
│  │ Role: Control+Worker │         │ Role: Worker         │     │
...
| Resource | Used | Total | % |
|----------|------|-------|---|
| **CPU** | ~5.5 cores | 8 cores | 68% |
| **Memory** | ~8.5GB | 32GB | 26% |
